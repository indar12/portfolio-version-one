  ...
  return (
      <Container>
          <Wrapper>
              ...
              <ContactForm ref={form} onSubmit={sendEmail}> {/* Add ref to the form */}
                  <ContactTitle>Email Me 🚀</ContactTitle>
                  <ContactInput placeholder="Your Email" name="name" required /> {/* Added required attribute */}
                  <ContactInput placeholder="Your Name" name="name" required/> {/* Added required attribute */}
